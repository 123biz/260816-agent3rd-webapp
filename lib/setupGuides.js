...
export const setupGuides = {
  ...
  netlify: {
    toolName: "Netlify",
    question: "GitHub와 Netlify 모두 가입하셨나요? (둘 다 무료)",
    badge: "💡 TIP",
    title: "Netlify 가입 방법",
  ...
  github: {
    ...
    badge: "🚀 STEP GUIDE",
    title: "GitHub 가입 방법",
    subtitle: "Netlify 가입 시 GitHub 계정을 쓰면 더 편해요",
    steps: [
      (
        <>
          브라우저에서{" "}
      ...
      "우측 상단 'Sign up' 버튼을 클릭하세요.",
      "이메일, 비밀번호, 사용자명(Username)을 입력하세요.",
      "이메일로 받은 인증 코드를 입력해 인증을 완료하세요.",
      "가입이 끝나면 그 계정으로 Netlify에 가입할 수 있어요!",
    ],
  },
  folder: {
    toolName: "프로젝트 폴더",
    ...
    steps: [
      ...
      "나중에 5단계에서 다운로드 받은 파일을 이 폴더(C:\\Antigravity)에 저장할 예정입니다.",
    ],
  },
};
